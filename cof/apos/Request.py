...
from cof.utils import Constants, AES
from cof.utils import Encoder
from cof.utils import TagConstants
from cof.utils import Utils
...
class RefundRequest(Request):
    def __init__(self, refundRequestDto):
        super().__init__(refundRequestDto.shop_id, refundRequestDto.operator_id, refundRequestDto.options)
...
class OrderStatusRequest(Request):
    def __init__(self, order_id, shop_id, operator_id, product_ref=None, options=None):
        super().__init__(shop_id, operator_id, options)
...
class ConfirmTransactionRequest(Request):
    def __init__(self, confirmTransactionRequestDto):
        super().__init__(confirmTransactionRequestDto.shop_id, confirmTransactionRequestDto.operator_id, confirmTransactionRequestDto.options)
...
class PaymentRequest:
    def __init__(self, tokenizeRequestDto):
        self._shop_id = tokenizeRequestDto.shop_id
        self._options = tokenizeRequestDto.options
        self._amount = tokenizeRequestDto.amount
        self._currency = tokenizeRequestDto.currency
        self._order_id = tokenizeRequestDto.order_id
        self._url_back = tokenizeRequestDto.url_back
        self._url_done = tokenizeRequestDto.url_done
        self._url_ms = tokenizeRequestDto.url_ms
        self._accounting_mode = tokenizeRequestDto.accounting_mode
        self._author_mode = tokenizeRequestDto.author_mode
        self._exponent = tokenizeRequestDto.exponent
        self._name = tokenizeRequestDto.name
        self._surname = tokenizeRequestDto.surname
        self._tax_id = tokenizeRequestDto.tax_id
        self._lock_card = tokenizeRequestDto.lock_card
        self._commis = tokenizeRequestDto.commis
        self._ord_descr = tokenizeRequestDto.ord_descr
        self._VSID = tokenizeRequestDto.VSID
        self._op_descr = tokenizeRequestDto.op_descr
        self._remaining_duration = tokenizeRequestDto.remaining_duration
        self._userId = tokenizeRequestDto.user_id
        self._bb_poste_pay = tokenizeRequestDto.bb_poste_pay
        self._bp_cards = tokenizeRequestDto.bp_cards
        self._phone_number = tokenizeRequestDto.phone_number
        self._causation = tokenizeRequestDto.causation
        self._user = tokenizeRequestDto.user
        self._product_ref = tokenizeRequestDto.product_ref
        self._anti_fraud = tokenizeRequestDto.anti_fraud
        self._url_back = tokenizeRequestDto.url_back
        self._lang = tokenizeRequestDto.lang
        self._shop_email = tokenizeRequestDto.shop_email
        self._data_3DS_json = tokenizeRequestDto.data_3DS_json
